...
export const gameToast = {
  success: (message: string) =>
    toast.custom((t) => (
      <div
        className={`${
          t.visible ? "animate-in fade-in slide-in-from-right-full" : "animate-out fade-out slide-out-to-right-full"
        ...
        <div className="flex-1 p-4 bg-gradient-to-r from-blue-500/5 to-transparent">
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <p className="text-sm font-black text-white uppercase tracking-wider italic">Move Recorded</p>
      ...
      >
        <div className="flex-1 p-4 bg-gradient-to-r from-red-500/5 to-transparent">
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <p className="text-sm font-black text-white uppercase tracking-wider italic">Invalid Move</p>
              <p className="mt-1 text-sm text-zinc-400">{message}</p>
            </div>
          </div>
        </div>
    ...
    toast.custom((t) => (
      ...
      >
        <div className="flex-1 p-6 bg-gradient-to-b from-amber-500/10 to-transparent flex flex-col items-center text-center">
          ...
          <h3 className="text-2xl font-black text-white uppercase tracking-tighter italic">Victory!</h3>
          <p className="mt-2 text-zinc-300 font-medium">You've claimed the prize pool of</p>
      ...
      >
        <div className="flex-1 p-4 flex items-center gap-4">
          ...
          <div className="flex-1 text-left">
            <p className="text-xs font-black text-blue-500 uppercase">New Challenge</p>
            <p className="text-sm font-bold text-white truncate">{player} wants to play!</p>
          </div>
        </div>
      </div>
    )),
